...
#[test]
fn test_expectation_cpp_code_cache() {
   let _ = env_logger::try_init();

   let test_case = Path::new("tests").join("expectations").join("cpp_code_cache.rs");
   let base_name = test_case.file_stem().expect("name without extenstion");
   let test_name = base_name.to_string_lossy();
...
#[test]
fn test_expectation_fenum() {
   let _ = env_logger::try_init();

   let test_case = Path::new("tests").join("expectations").join("fenum.rs");
   let base_name = test_case.file_stem().expect("name without extenstion");
   let test_name = base_name.to_string_lossy();
...
#[test]
fn test_expectation_cenum() {
   let _ = env_logger::try_init();

   let test_case = Path::new("tests").join("expectations").join("cenum.rs");
   let base_name = test_case.file_stem().expect("name without extenstion");
   let test_name = base_name.to_string_lossy();
...
#[test]
fn test_expectation_c_self_type() {
   let _ = env_logger::try_init();

   let test_case = Path::new("tests").join("expectations").join("c_self_type.rs");
   let base_name = test_case.file_stem().expect("name without extenstion");
   let test_name = base_name.to_string_lossy();
